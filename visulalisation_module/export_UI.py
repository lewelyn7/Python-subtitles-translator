...
class Ui_export_dialog(object):
    def setupUi(self, export_dialog):
        ...
        export_dialog.setMaximumSize(QtCore.QSize(16777215, 239))
        ...
        self.column_order_lbl = QtWidgets.QLabel(self.groupBox)
        self.column_order_lbl.setObjectName("column_order_lbl")
        self.gridLayout_3.addWidget(self.column_order_lbl, 2, 0, 1, 2)
        self.column_order_combo = QtWidgets.QComboBox(self.groupBox)
        self.column_order_combo.setObjectName("column_order_combo")
        self.column_order_combo.addItem("")
        self.column_order_combo.addItem("")
        self.gridLayout_3.addWidget(self.column_order_combo, 2, 2, 1, 2)
